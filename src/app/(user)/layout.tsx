...
// }>) => {
//     return (
//         <div className="flex flex-row bg-linear-to-br from-background to-background/95  h-dvh">
//             <ResizablePanelGroup direction="horizontal">
//                 <ResizablePanel
//                     minSize={15}
//                     maxSize={30}
//                     defaultSize={15}
//                     className="bg-box-background/50 backdrop-blur-xs border-r border-box-hover/10"
//                 >
//                     <NavBar />
//                 </ResizablePanel>
